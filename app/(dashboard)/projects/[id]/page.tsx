      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => setZoom(z => Math.max(0.5, z - 0.2))} className="px-3 py-1.5 rounded-lg text-xs border border-gray-200 text-gray-600">— Zoom out</button>
            <button onClick={() => setZoom(z => Math.min(2.5, z + 0.2))} className="px-3 py-1.5 rounded-lg text-xs border border-gray-200 text-gray-600">Zoom in +</button>
            <button className="px-3 py-1.5 rounded-lg text-xs border border-gray-200 text-gray-600">Export PDF</button>
            <button className="px-3 py-1.5 bg-blue-600 text-white rounded-lg text-xs font-medium">Share</button>
          </div>
        </div>
        {/* Progress bar */}
